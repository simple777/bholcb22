                ...
                <div class="play">
					...
					<div class="play-games">
                        ...
                        <div class="play-nymosaic-frame">
                            <h3>«Каждый ребенок имеет право»: электронная викторина </h3>
                            <iframe src="https://learningapps.org/watch?v=p2cyr3s6221" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Нет прав без обязанностей»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?v=pfquibkic21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«С правом по жизни»:  Игра-онлайн (Пазл)</h3>
                            <iframe src="https://learningapps.org/watch?v=psfjy4qzk21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
