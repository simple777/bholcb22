                ...
                <div class="play">
					...
					<div class="play-games">
                        ...
                        <div class="play-nymosaic-frame">
                            <h3>«Всё самое летнее»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?app=21011497" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Всё самое, самое»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?app=20730933" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>От Бреста до Владивостока». Кроссворд – онлайн</h3>
                            <iframe src="https://learningapps.org/watch?v=ppig56hat21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Путешествие на диване» Кроссворд – онлайн</h3>
                            <iframe src="https://learningapps.org/watch?v=ps08eudbc21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Яркие женщины – яркие судьбы»: Кроссворд - онлайн</h3>
                            <iframe src="https://learningapps.org/watch?v=pbpan0y9a21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
