                ...
                <div class="play">
					...
					<div class="play-games">
                        ...
                        <div class="play-nymosaic-frame">
                            <h3>«Осенний пейзаж»: электронная викторина (Осень в картинах русских художников)</h3>
                            <iframe src="https://learningapps.org/watch?v=pkiy5425a21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
