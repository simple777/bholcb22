                ...
                <div class="play">
					...
					<div class="play-games">
                        ...
                        <div class="play-nymosaic-frame">
                            <h3>«Где любовь да доброта, там и красота»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?app=21130829" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Придет осень - за всё спросит»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?app=21094536" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
