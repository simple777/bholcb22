            ...
            <div class="play-wrapper">
                ...
                <div class="play">
                    ...
                    <div class="play-nymosaic-frame">
                        <h3>«Государства и столицы»: Игра-онлайн (таблица соответствий)</h3>
                        <iframe src="https://learningapps.org/watch?v=p60rb9pak21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>

                    <div class="play-nymosaic-frame">
                        <h3>«Моя Родина – Россия»: электронная викторина</h3>
                        <iframe src="https://learningapps.org/watch?v=p7cfc9v4k21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>

                    <div class="play-nymosaic-frame">
                        <h3>«По странам и континентам»: электронная викторина </h3>
                        <iframe src="https://learningapps.org/watch?app=20943076" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>

                    <div class="play-nymosaic-frame">
                        <h3>«С гордостью о России»: электронная викторина ко Дню России</h3>
                        <iframe src="https://learningapps.org/watch?app=20519552" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>

                    <div class="play-nymosaic-frame">
                        <h3>«Флаг России»: электронная викторина</h3>
                        <iframe src="https://learningapps.org/watch?app=20965474" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>
