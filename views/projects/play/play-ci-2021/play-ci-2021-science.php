                ...
                <div class="play">
					...
					<div class="play-games">
                        ...
                        <div class="play-nymosaic-frame">
                            <h3>«Великие учёные и их открытия»: Кроссворд -онлайн</h3>
                            <iframe src="https://learningapps.org/watch?v=pexvyzdxc21" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>

                        <div class="play-nymosaic-frame">
                            <h3>«Люди, изменившие мир»: электронная викторина</h3>
                            <iframe src="https://learningapps.org/watch?app=19260464 " style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                        </div>
