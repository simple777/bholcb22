...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SITEURL;?>css/projects.css?v04">
            ...
            <div class="play-wrapper-wide">
                ...
                <div class="play">
					...
					<div class="play-nymosaic-frame">
						<h3>Задание 1</h3>
						<iframe src="https://learningapps.org/watch?v=p09gsk3mc20" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
					</div>	
					
					<div class="play-nymosaic-frame">					
						<h3>Задание 2</h3>
						<iframe src="https://learningapps.org/watch?v=pphznrixn20" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
					</div>

					<div class="play-nymosaic-frame">					
						<h3>Задание 3</h3>
						<iframe src="https://learningapps.org/watch?v=pp95hs8kn20" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
					</div>

					<div class="play-nymosaic-frame">					
						<h3>Задание 4</h3>
						<iframe src="https://learningapps.org/watch?v=pfy3qx98520" style="border:0px;width:100%;height:800px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
					</div>
					
					<div class="play-nymosaic-frame">
						<h3>Задание 5</h3>
						<iframe src="https://learningapps.org/watch?v=pnp55j3n520" style="border:0px;width:100%;height:400px" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
					</div>
