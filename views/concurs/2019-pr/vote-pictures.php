		...
		<div class="content-wrapper clearfix">
			...
			<main role="main" class="content">
                ...
                <div class="vote-wrapper">
                    <div class="vote" id="2019-pr-pictures">

                        <h2>Пасхальная радость. Рисунки. Результаты</h2>
                       ...
                       <!-- <p style="color: #e0dcd7; text-align: center" id="vote-note">Можно проголосовать только за одну работу</p> -->
                        ...
                        $vote_array = vote_Get_All_Load_ORDERBY_VOICES($mysqli, $tablename);
...
<script src="<?php echo SITEURL;?>js/vote.js?v09"></script>
