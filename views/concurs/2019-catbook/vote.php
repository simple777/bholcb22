			...
			<main role="main" class="content">
                ...
                <div class="vote-wrapper">
                    <div class="vote">
                        ...
                        <h2>Кошка, книжка, я - лучшие друзья! Результаты!</h2>


                        <!-- <p style="color: #e0dcd7; text-align: center" id="vote-note">Вы можете отдать пять голосов!</p> -->
                        <p style="color: #e0dcd7; text-align: center"><a href="http://bholcb.ru/concurs/koshka-knizhka-ja-luchshie-druzja.html" target="_blank">О конкурсе</a></p>
                        ...
                        //connect to database
                        $mysqli = sql_Connect();
                        $tablename = 'lib777_vote_2019_cat';

                        $vote_array = vote_Get_All_TOP($mysqli, $tablename);
...
<!--<script src="<?php //echo SITEURL;?>js/vote.js?v1.01"></script>-->
