		...
		<div class="content-wrapper clearfix">
			...
			<main role="main" class="content">
                ...
                <div class="department-wrapper">
                    <div class="department otdel_obslug">
                        ...
                        <div class="department-common-info-content">
                            <div class="department-common-info-content-in">
                                <div class="department-common-info-content-in-text">
                                    ...
                                    <h2>Отдел обслуживания</h2>


                                        <div class="department-about">

                                            <img src="<?php echo SITEURL; ?>images/pages/structure/otdel_obslug/obslug.jpg" width="800px" height="600px" class="department-prev">
                                        ...
                                        <ul class="department-about-list">
                                            <li>&nbsp;Совершенствование библиотечно-библиографического обслуживания пользователей с использованием различных форм индивидуальной и массовой работы</li>
                                            <li>&nbsp;Оперативное и качественное удовлетворение разнообразных потребностей пользователей</li>
                                        </ul>
                                        ...
                                        <div class="department-workers-item">
                                            <div class="department-workers-item-main">
                                                <img src="<?php echo SITEURL; ?>images/pages/structure/otdel_obslug/people/maksimova-ta.png" width="180px" height="180px">
                                            </div>
                                            <div class="department-workers-item-contacts">
                                                <div class="department-fio">Максимова<br> Татьяна Александровна</div>
                                            </div>
                                        </div>

                                        <div class="department-workers-item">
                                            <div class="department-workers-item-main">
                                                <img src="<?php echo SITEURL; ?>images/pages/structure/otdel_obslug/people/marakulina-va.png" width="180px" height="180px">
                                            </div>
                                            <div class="department-workers-item-contacts">
                                                <div class="department-fio">Маракулина<br> Вера Анатольевна</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="department-workers-item">
                                            <div class="department-workers-item-main">
                                                <img src="<?php echo SITEURL; ?>images/pages/structure/otdel_obslug/people/vorobeva-ea.png" width="180px" height="180px">
                                            </div>
                                            <div class="department-workers-item-contacts">
                                                <div class="department-fio">Воробьева<br> Екатерина Антоновна</div>
                                            </div>
                                        </div>
