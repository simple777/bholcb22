			...
			<main role="main" class="content">
                ...
                <div class="about-success-wrapper">
                    <div class="about-success">
                        ...
                        <h2>Награды сотрудников</h2>

                        <div class="about-success-personal-row clearfix">
                            <div class="about-success-personal-row-image-wrapper">
                                <img src="<?php echo SITEURL;?>images/pages/about/success/personal/shvareva-va.jpg" class="minimized" alt="Шварева В.А.">
                                <span>Шварева В.А.</span>
                            </div>
                            <p>2004 г. - Знак Министерства культуры «За достижения в культуре» награждена заведующая Подрезчихинской БФ Шварева Вера Анатольевна.</p>
                        </div>

                        <div class="about-success-personal-row clearfix">
                            <div class="about-success-personal-row-image-wrapper">
                                <img src="<?php echo SITEURL;?>images/pages/about/success/personal/richkova-gs.jpg" class="minimized" alt="Рычкова Г.С.">
                                <span>Рычкова Г.С.</span>
                            </div>
                            <p>1998 г. - Знак Министерства культуры РФ «За достижения в культуре»
                               2005 г. - Звание «Заслуженный работник культуры» присвоено Рычковой Галине Сергеевне
                               директору Белохолуницкой централизованной библиотечной системы с 1975 по 2009 годы.</p>
                        </div>
