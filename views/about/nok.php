	...
	<div class="page-wrapper">
		...
		<div class="content-wrapper clearfix">
			...
			<main role="main" class="content">
                ...
                <div class="readers-rules-wrapper" style="width: 97%">
                     <div class="project-victory" style="background: none !important">
               
                        <!-- <h2>Оценка качества оказания услуг в МБУК БЦБ</h2> -->
						
						<div class="project-victory-col1" style="width: 70%">
							<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScKSiw7jLYP8mx09fIYv7WTKLiep3JYtkYQs28XUsfkr1D5oA/viewform?embedded=true" width="640" height="1487" frameborder="0" marginheight="0" marginwidth="0" style="width: 100%;min-height: 1585px;margin-bottom: 2.1em;">Загрузка…</iframe>
						</div>
