                    ...
                    <div class="p-big-text">
                        ...
                        <div class="afisha-single">
                            <div class="afisha-single-content">
                                ...
                                <img src="<?php echo SITEURL;?>media/afisha/buket-kotov/bk-1.jpg">

                                <p>К выбору праздничного букета надо подходить правильно!</p>
                                <p>К 8 Марта детская библиотека предложила вниманию посетителей оригинальный «Букет котов»
                                    из работ кружковцев под руководством Елены Викторовны Шмаковой (Городской Дом культуры).</p>

                                <img src="<?php echo SITEURL;?>media/afisha/buket-kotov/bk-2.jpg">


                                <p style="text-align: center; font-size: 1em">Светлана Анатольевна Зубова, заведующая детской библиотекой им. Н.И. Марихина</p>
