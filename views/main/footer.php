		<footer>
            ...
            <div class="footer-main-wrapper">
                <div class="footer-content-wrapper clearfix">
                    ...
                    <section class="footer-nav">
                        <nav role="navigation" class="">
                            <h4 class="rounded-corners-5px">Читателям</h4>
                    ...
                    <section class="footer-nav">
                        <nav role="navigation" class="">
                            <h4 class="rounded-corners-5px">Коллегам</h4>
                            <ul class="footer-nav-list">
                    ...
                    <section class="footer-info">
                        <h4>График работы библиотеки:</h4>
                ...
                <div class="footer-copyright"><div class="footer-text">2021 г. МБУК Белохолуницкая ЦБ</div>&nbsp;&nbsp;<?php include_once  SITEROOTDIR.'views/main/counter.php'; ?></div>
            </div>
        </footer>